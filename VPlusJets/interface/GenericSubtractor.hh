...
public:
  ...
  GenericSubtractor(fastjet::BackgroundEstimatorBase *bge_rho,
		    fastjet::BackgroundEstimatorBase *bge_rhom=0) :
  ...
  double operator()(const fastjet::FunctionOfPseudoJet<double> &shape,
		    const fastjet::PseudoJet &) const;
...
protected:
  ...
  /// the derivative.
  void _compute_derivatives(const fastjet::FunctionOfPseudoJet<double> &shape,
  ...
  double _optimize_step(const fastjet::FunctionOfPseudoJet<double> &shape,
                        const fastjet::PseudoJet &jet,
                        const double original_ghost_scale,
                        const double ghost_area,
  ...
  double _shape_with_rescaled_ghosts(const fastjet::FunctionOfPseudoJet<double> &shape,
				     const fastjet::PseudoJet &jet,
				     const double original_ghost_scale,
