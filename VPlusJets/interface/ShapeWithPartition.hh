...
class ShapeWithPartition : public fastjet::FunctionOfPseudoJet<double>{
public:
  ...
  virtual fastjet::PseudoJet partition(const fastjet::PseudoJet &jet) const = 0;

  /// return the result of the shape computed from a given partition
  virtual double result_from_partition(const fastjet::PseudoJet &partit) const = 0;
